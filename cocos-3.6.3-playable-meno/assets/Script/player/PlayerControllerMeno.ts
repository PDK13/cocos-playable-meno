...
@ccclass('PlayerControllerMeno')
export class PlayerControllerMeno extends PlayerController {
    ...
    onJump(dt: number) {
        ...
        if (this.m_finish || this.m_lockInput || this.m_lockJump || !this.m_control)
            return;
